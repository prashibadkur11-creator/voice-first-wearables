...
A voice authentication and command library for wearables: smart glasses, earbuds, and rings.
...
> The library owns the flow (validation, auth ladder, confirmation gates, dispatch). You own the implementation (verifiers, handlers, UX).

[TODO: what I was building when I needed this, and what broke without it]
...
W1/W2 are deliberately warn-only. High-stakes gating is the library's opinion, and the developer can override it. The warning makes the choice visible.
...
[TODO: what MockVerifier proves and what it does not]

[TODO: which paths have never run against real hardware or a real STT stack]

[TODO: W1/W2 are warn-only, so what can still ship misconfigured]

[TODO: single-wearer assumption, and what breaks on shared devices]
